		...
		<div className='flex flex-col h-screen'>
			<header className='text-black flex items-center justify-center flex-col px-10 py-12'>
				...
				>
					<p>
						MIE-
						<span className='text-cyan-600'>Tienda Online</span>
					</p>
				</Link>
			</header>
			...
			<main className='container flex-1 flex flex-col items-center gap-10'>
				<div className='flex gap-3 items-center'>
					...
					<p className='text-4xl'>
						¡Gracias, {data.customer.first_name}{''}{data.customer.last_name} !
					</p>
				</div>

				<div className='border border-cyan-400 w-full md:w-[600px] p-5 rounded-md space-y-3'>
					<h3 className='font-medium'>Tu pedido está confirmado</h3>

					<p className='text-sm'>
						Gracias por realizar tu compra en MIE Tienda Online. Para
					...
					<div className='space-y-0.5 text-sm'>
						<p>BANCO PICHINCHA</p>
						<p>Razón Social: MIE Tienda Online</p>
					...
					<p className='text-sm'>
						...
						comprobante a ventas@mietiendaonline.com para procesarla
						y hacerte la entrega de tu dispositivo a domicilio.
					</p>
				</div>

				<div className='border border-cyan-400 w-full p-5 rounded-md space-y-3 md:w-[600px]'>
									...
									<div className='flex-1 space-y-2'>
										...
										<div className='flex gap-3'>
											<p className='text-[13px] text-gray-600'>
												{item.category} / {item.variant_name}
											</p>
										</div>
									</div>
								</li>
